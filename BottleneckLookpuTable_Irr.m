...
lookup_t=LookupTable_Construction(H_Class.check_edge_dis,H_Class.vari_edge_dis,prob_join_x_t,MaxIter,H_Class.dc_max,H_Class.dv_max,T,puncrate_c);
[CMapping,VMapping]=lookup_t.Mapping_Construction (MaxRun);
[vari_lt,check_lt]=lookup_t.lt_construction(CMapping,VMapping);
lookup_t.mutual_information_plot(0.7);
lookup_t.LLR_Table();
