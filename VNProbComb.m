...
%   Output: Combination of [Y1,Y2] and ProbJoinXY1Y2
 ...
 for ii=1:size(Combination,1)
     ProbComb(1,ii)=ProbJoinX1Y1(1,Combination(ii,1))*ProbJoinX2Y2(1,Combination(ii,2))/ProbX(1);
     ProbComb(2,ii)=ProbJoinX1Y1(2,Combination(ii,1))*ProbJoinX2Y2(2,Combination(ii,2))/ProbX(1);
 end
